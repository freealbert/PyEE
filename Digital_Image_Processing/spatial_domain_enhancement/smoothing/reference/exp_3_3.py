...
ax_1.imshow(im_0,cmap=cm.gray,norm=pl.Normalize(vmin=0,vmax=1))
...
ax_2.imshow(im_1,cmap=cm.gray,norm=pl.Normalize(vmin=0,vmax=1))
...
ax_3.imshow(im_2,cmap=cm.gray,norm=pl.Normalize(vmin=0,vmax=1))
