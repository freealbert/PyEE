...
ax1.imshow(circuit_0,cmap=cm.gray,norm=pl.Normalize(vmin=0,vmax=1))
...
ax2.imshow(circuit_1,cmap=cm.gray,norm=pl.Normalize(vmin=0,vmax=1))
ax2.set_title('output image')
fig.suptitle('exp_1_5')
fig.savefig('exp_1_5.jpg')
fig.savefig('exp_1_5.eps')
